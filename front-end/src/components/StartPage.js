                ...
                <div className="input_style">
                    {
                        ...
                        <textarea placeholder="What's your observation?" value={observation} onChange={(e) => {setObservation(e.target.value); onObsMouseOut()}} rows="2" cols="17"></textarea> 
                    </div>
                ...
                <div className="input_style">
                    {
                        isMobile ? <div className="textarea">
                            <textarea placeholder="What's your hypothesis?" value={hypothesis} onChange={(e) => setHypothesis(e.target.value)} rows="6" cols="17">
